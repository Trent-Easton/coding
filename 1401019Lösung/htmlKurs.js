...
function auswertung() {
    ...
    document.getElementById("ergebnis").value =
        anrede + " " + vorname + " " + nachname + " (" + wichtig + ") mit Kennwort " + kennwort +
        " aus " + ort + ", hat am " + geburtstag + " Geburtstag, die Telefonnummer " + telefon +
        ", die Mailadresse " + email + ", die Homepage " + homepage + ", die Schulnote " + schulnote +
        " und verdient " + gehalt + " Euro.";
}
